...
export default function projectsView() {
  ...
  onMount(async () => {
    ...
    setUserMeta((await getKind0Event(pub as string)) as UserMeta)
  })
      ...
      <div class="navbar bg-neutral">
        ...
        <div class="flex-1">
          <div class="dropdown dropdown-hover">
            <label
              tabindex="0"
              class="btn p-0 bg-neutral-focus hover:bg-primary"
            >
              <FiFolder class="mx-2" />
